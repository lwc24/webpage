...
/***/ function(module, exports, __webpack_require__) {
	...
	var _user$project$Models$init = {ctor: '_Tuple2', _0: _user$project$Models$initModel, _1: _elm_lang$core$Platform_Cmd$none};
	var _user$project$Models$Player = F3(
		function (a, b, c) {
			return {id: a, name: b, points: c};
		});
	var _user$project$Models$Play = F4(
		function (a, b, c, d) {
	...
	var _user$project$Models$DeletePlay = function (a) {
		return {ctor: 'DeletePlay', _0: a};
	};
	var _user$project$Models$Cancel = {ctor: 'Cancel'};
	var _user$project$Models$Save = {ctor: 'Save'};
	var _user$project$Models$Input = function (a) {
		return {ctor: 'Input', _0: a};
	};
	var _user$project$Models$Score = F2(
		function (a, b) {
			return {ctor: 'Score', _0: a, _1: b};
		});
	var _user$project$Models$Edit = function (a) {
		return {ctor: 'Edit', _0: a};
	};

	var _user$project$Views$playerForm = function (model) {
		return A2(
			_elm_lang$html$Html$form,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Events$onSubmit(_user$project$Models$Save)
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$html$Html_Events$onInput(_user$project$Models$Input),
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$html$Html_Events$onClick(_user$project$Models$Cancel)
						]),
					_elm_lang$core$Native_List.fromArray(
						[
	...
	var _user$project$Views$pointTotal = function (model) {
	...
	var _user$project$Views$player = function (player) {
		return A2(
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_user$project$Models$Edit(player))
						]),
					_elm_lang$core$Native_List.fromArray(
						[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$type$('button'),
							_elm_lang$html$Html_Events$onClick(
							A2(_user$project$Models$Score, player, 2))
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('2 pts')
						])),
					A2(
					_elm_lang$html$Html$button,
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$type$('button'),
							_elm_lang$html$Html_Events$onClick(
							A2(_user$project$Models$Score, player, 3))
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('3 pts')
						])),
					A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
	...
	var _user$project$Views$playerList = function (model) {
		return A2(
	...
	var _user$project$Views$playerListHeader = A2(
	...
	var _user$project$Views$playerSection = function (model) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[]),
			_elm_lang$core$Native_List.fromArray(
				[
					_user$project$Views$playerListHeader,
					_user$project$Views$playerList(model),
					_user$project$Views$pointTotal(model)
				]));
	};
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_user$project$Views$playerSection(model),
					_user$project$Views$playerForm(model),
					A2(
	...
	var _user$project$Main$main = {
		main: _elm_lang$html$Html_App$program(
			{init: _user$project$Models$init, view: _user$project$Views$view, update: _user$project$Update$update, subscriptions: _user$project$Update$subscriptions})
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!!./MyStyle.css", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!!./MyStyle.css");
